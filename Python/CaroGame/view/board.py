...
class CaroBoard(tk.Tk):
    ...
    def _create_score_display(self):
        ...
        self.x_score_label = tk.Label(score_frame, text="X: 0", font=font.Font(family="Arial", size=16), 
                                      bg="#f0f0f0", fg="#000000")  # Thay #333333 bằng #000000
    ...
    def _create_board_display(self):
        self.display = tk.Label(self, text="Ready?", font=font.Font(family="Arial", size=16), bg="#f0f0f0", fg="#000000")  # Thay #333333 bằng #000000
    ...
    def _show_game_over_overlay(self, msg, color):
        ...
        result_label = tk.Label(content_frame, text=msg, font=font.Font(family="Arial", size=16), bg="#ffffff", fg="#000000")  # Thay #333333 bằng #000000
    ...
    def highlight_suggested_move(self, row, col):
        ...
        for button, coords in self._cells.items():
            if coords == (row, col) and (row, col) not in self._played_cells:
                button.config(bg=self._colors["suggestion"])  # Đảm bảo tô màu gợi ý
